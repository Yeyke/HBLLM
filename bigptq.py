...
"""
HBRAGPTQ is the meaning of GPTQ using Haar Binary Residual Approximation in the paper to realize 1-bit quantization.
HBRAGPTQ applies Haar transform to on the weight matrix enhance the representation before binary residual quantization.
"""
class HBRAGPTQ:
    ...
    def fasterquant(
        ...
        for blocki, col_st in enumerate(range(0, self.columns, blocksize)):
            ...
            mask1, mask2 = structural_guassian_distribution(
            ...
            if self.disable_gptq:
                ...
                Q1 = self.braq_quantizer.quantize(W1, mask[1], mask[0])
